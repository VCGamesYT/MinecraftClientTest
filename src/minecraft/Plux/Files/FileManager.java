...
public class FileManager
{
    ...
    static {
        ...
        FileManager.directory = new File(String.valueOf(String.valueOf(Minecraft.getMinecraft().mcDataDir.toString())) + "\\" + Plux.Name);
        FileManager.moduleDirectory = new File(String.valueOf(String.valueOf(Minecraft.getMinecraft().mcDataDir.toString())) + "\\" + Plux.Name + "\\" + "Modules");
    }
