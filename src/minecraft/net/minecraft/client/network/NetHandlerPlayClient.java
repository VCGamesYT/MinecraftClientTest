...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleEntityVelocity(S12PacketEntityVelocity packetIn)
    {
        ...
        if (var2 != null)
        {
        	if(Plux.instance.modManager.getModbyName("AntiVelocity").isToggled()){
    ...
    {
    if(p_147297_1_ instanceof C06PacketPlayerPosLook && Plux.instance.modManager.getModbyName("KillAura").isToggled()){
    	KillAura.poslook();
    		return;
    	}
    	if(p_147297_1_ instanceof C05PacketPlayerLook && Plux.instance.modManager.getModbyName("KillAura").isToggled()){
    		KillAura.look();
    		return;
    	}
