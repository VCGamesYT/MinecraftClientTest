...
import Plux.Plux;
import Plux.Event.events.EventKeyboard;
import Plux.Event.events.EventMiddleClick;
import Plux.Event.events.EventTick;
import Plux.Mod.Mod;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void func_175609_am() throws LWJGLException
    {
        ...
        Display.setTitle(Plux.instance.Name+" Is Loading...");
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                    	EventKeyboard eventKeyboard = new EventKeyboard(var1);
                        eventKeyboard.call();

                            for (Mod module : Plux.instance.modManager.getMods()) {
