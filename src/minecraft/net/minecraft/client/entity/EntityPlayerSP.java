...
import Plux.Plux;
import Plux.Event.events.EventPostMotionUpdates;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void func_175161_p()
    {
        ...
        if (this.func_175160_A())
        {
            ...
            if (this.ridingEntity == null)
            {
                ...
                if(sendLook == false && Plux.instance.modManager.getModbyName("KillAura").isToggled()){
                	this.sendQueue.addToSendQueue(new C03PacketPlayer.C05PacketPlayerLook(this.rotationYaw, this.rotationPitch, this.onGround));
                }
            }
            else
    ...
    {
    	if(Plux.onSendChatMessage(p_71165_1_)){
    ...
    public void onLivingUpdate()
    {
        ...
        {
        	if(Plux.instance.modManager.getModbyName("NoSlowDown").isToggled()){
